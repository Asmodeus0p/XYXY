...
public class MasterDetailLiveAdapter extends BaseAdapter {
    ...
    public MasterDetailLiveAdapter( Context context,List<MasterDetailBean.DataBean.LiveCoursesBean> liveCoursesBeen) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.title.setText(liveCoursesBeen.get(position).getTitle());

        viewHolder.time.setText(String.format("直播时间 : %s", liveCoursesBeen.get(position).getStartDate()));

        viewHolder.type.setText("直播预告");
        return convertView;
    }
