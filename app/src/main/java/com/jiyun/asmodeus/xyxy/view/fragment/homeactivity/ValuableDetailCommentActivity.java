...
import com.jiyun.asmodeus.xyxy.model.biz.IValuableCommentReplyPost;
import com.jiyun.asmodeus.xyxy.model.biz.IValuableReplyList;
...
public class ValuableDetailCommentActivity extends BaselivstActivity {
    ...
    public static void start(Activity activity, int commentId, int userId, int workId, String tContent, int replyNum) {
        Intent intent = new Intent(activity, ValuableDetailCommentActivity.class);
        ...
        adapter.setOnItemShareClick(new WorkDetailCommentAdapter.OnItemShareClick() {
            ...
            public void onPraiseClick(int position) {
                ...
                if(favorite==Constant.NOTFAVORITE){
                    parise(commentList.get(position).getUserId(),commentList.get(position).getId(),Constant.Praise_valuable_huifu);
                    commentList.get(position).setIsPraise(Constant.FAVORITE);
                }else{
                    pariseCancle(commentList.get(position).getUserId(),commentList.get(position).getId(),Constant.Praise_valuable_huifu);
        ...
        switch (view.getId()){
            ...
            case R.id.wok_detail_comment_aty_praise_cb:
                ...
                if(favorite==Constant.NOTFAVORITE){
                    ...
                    parise(commentBean.getUserId(),commentBean.getId(),Constant.Praise_valuable_comment);
                    commentBean.setIsPraise(Constant.FAVORITE);
                    wok_detail_comment_aty_praise_cb.setText((commentBean.getPraiseNum()+1)+"");
                }else{
                    pariseCancle(commentBean.getUserId(),commentBean.getId(),Constant.Praise_valuable_comment);
    ...
    private void postComment(String content,int replyId){
        ...
        HttpHelp.baseHttpRequest(context,Constant.Root_url)
                .create(IValuableCommentReplyPost.class)
    ...
    private void loadContent(){
        ...
        HttpHelp.baseHttpRequest(context, Constant.Root_url)
                .create(IValuableReplyList.class)
